...
uint8_t numNode1 = '6';                                                     //Change here (2).
uint8_t numNode2 = '9';                                                     //Change here (3).
int replyNum = 0;
int reTry = 0;
...
float numHumidity;
float numValue = 69.69;

TaskHandle_t loraThread;
...
void lora_thread (void *parameter)
{
  ...
  while (1) {
    ...
    strcpy(nodeMessage, "69");                                                //Change here (4).
